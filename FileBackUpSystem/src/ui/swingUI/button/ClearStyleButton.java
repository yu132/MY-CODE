...
public class ClearStyleButton extends SpecialButton{
	...
	public ClearStyleButton() {
		...
		this.setBounds(IntervalSize.getInterval_1_Size_X()+ComponentSize.getNOW_STRING_LABEL_SIZE_X()+2*IntervalSize.getInterval_3_Size_X()+ComponentSize.getNOW_LIST_PANEL_SIZE_X() - 10,
				IntervalSize.getInterval_2_Size_Y()+ComponentSize.getNOW_TO_PATH_SIZE_Y()+2*IntervalSize.getInterval_3_Size_Y()+ComponentSize.getNOW_R_3_BUTTON_SIZE_Y()+IntervalSize.getInterval_4_Size_Y(),
