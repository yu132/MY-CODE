...
public class ExchangeButton extends JLabel{
	...
	public ExchangeButton() {
		...
		this.setBounds(IntervalSize.getInterval_1_Size_X()+ComponentSize.getNOW_STRING_LABEL_SIZE_X()+2*IntervalSize.getInterval_3_Size_X()
				+ComponentSize.getNOW_3_BUTTON_SIZE_X()- 10,
